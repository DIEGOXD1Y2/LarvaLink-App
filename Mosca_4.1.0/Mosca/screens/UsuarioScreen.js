...
export default function UsuarioScreen({ route }) {
  ...
  const [inputValue, setInputValue] = useState('');       // Para teléfono o nueva contraseña
  const [currentPassword, setCurrentPassword] = useState(''); // Solo para cambio contraseña
  ...
  const handleSave = async () => {
    ...
    try {
      if (modalType === 'telefono') {
        ...
        // Aquí enviamos contraseña actual y nueva para validar
    ...
    <View style={styles.container}>
      <View style={styles.card}>
        ...
        <View style={styles.infoRow}>
          <Text style={styles.label}>Número de usuario:</Text>
