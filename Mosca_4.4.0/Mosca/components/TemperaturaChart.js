    ...
    <View style={styles.container}>
      ...
      <View style={styles.controlsContainer}>
        ...
        <View style={styles.controlCard}>
          <View style={styles.controlHeader}>
            ...
            <Text style={styles.controlTitle}>Unidad de Temperatura</Text>
          </View>
          <Picker 
            selectedValue={unidadTemp} 
            onValueChange={setUnidadTemp} 
            style={styles.picker}
          >
      ...
      <View style={styles.chartSection}>
        <View style={styles.chartHeader}>
          <Text style={styles.chartTitle}>📈 Gráfica de Temperatura</Text>
          <Text style={styles.chartSubtitle}>
            {datos.length} registros • Intervalo: {intervaloMin} min • Unidad: {sufijo}
          </Text>
        </View>
          ...
          >
            <LineChart
              ...
              renderDotContent={({ x, y, index }) => (
                ...
                >
                  {temperaturas[index]}{unidadTemp === 'K' ? 'K' : '°'}
                </Text>
              )}
              chartConfig={{
