          ...
          <>
            ...
            <View style={styles.card}>
              <Text style={styles.item}>
                Temperatura Promedio: {incubadora.temperaturaPromedio ? incubadora.temperaturaPromedio.toFixed(1) : '---'} °C
              </Text>
              <Text style={styles.item}>
                Humedad Promedio: {incubadora.humedadPromedio ? incubadora.humedadPromedio.toFixed(1) : '---'} %
              </Text>
            </View>
